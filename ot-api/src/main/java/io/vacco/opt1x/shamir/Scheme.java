...
public class Scheme {
   ...
   *
   * <p><b>N.B.:</b> There is no way to determine whether the returned value is actually the
  ...
  public byte[] join(Map<Integer, byte[]> parts) {
    checkArgument(!parts.isEmpty(), "No parts provided");
