...
export const uiNs             = "/ns"
export const uiNsNsId         = "/ns/:nsId"
export const uiNsNsIdValues   = "/ns/:nsId/values"
export const uiValuesVid      = "/values/:vid"

export const uiGroupsIdFmt       = (gid: number)  => `/groups/${gid}`
export const uiNsNsIdFmt         = (nsId: number) => `/ns/${nsId}`
export const uiNsNsIdValuesFmt   = (nsId: number) => `/ns/${nsId}/values`
export const uiValuesVidFmt      = (vid: number)  => `/values/${vid}`
